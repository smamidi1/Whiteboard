...
<div class="content-wrapper">
    <div id="login">
        ...
        <form action= "Tacontroller" method="post" >
            ...
            <input type="text" name = "ta_name" placeholder="name" required>
            <input type="text" name = "ta_email" placeholder="email" required>
            <input type="text" name = "ta_phone" placeholder="phone" required>
            <input type="time" name = "ta_timings" placeholder="timings" required>
            <select name="day">
            ...
            <input type="text" name = "class_id" placeholder="classId" required>
